    ...
    create table Tenant (
        ...
        needsReview BOOLEAN DEFAULT 't' not null,
        ...
        requireUsername BOOLEAN DEFAULT 't' not null,
    ...
    create table TenantUser (
        ...
        lastSuccess TIMESTAMP WITHOUT TIME ZONE,
        successes INTEGER DEFAULT 0 not null,
        apiAccess BOOLEAN DEFAULT 'f' not null,
